                ...
                >
                  <td className="px-5 py-3">
                    <div className="flex items-center gap-1.5">
                      <span className={`font-medium ${isActive ? "text-indigo-700" : "text-slate-700"}`}>{m.model_name}</span>
                  ...
                  <td className="px-4 py-3 text-right mono font-semibold text-slate-700">
                    {m.accuracy_pct !== null ? `${Math.round(m.accuracy_pct)}%` : "—"}
                  </td>
                  <td className="px-4 py-3 text-right mono text-slate-600">
